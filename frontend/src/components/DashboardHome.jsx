...
//         {/* Card 3 - Crawl & Test */}
//         <Link to="/crawl" className="group w-full max-w-sm">
//           <div className="bg-gradient-to-r from-purple-500 to-pink-600 p-6 rounded-xl shadow-xl transform transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl">
//             <div className="flex items-center justify-between">
//               <h2 className="text-2xl font-bold text-white group-hover:text-gray-800">Crawl & Test</h2>
//               <span className="text-white bg-pink-700 rounded-full px-3 py-1 text-xs font-bold">
//                 Go
//               </span>
//             </div>
//             <p className="text-white mt-3 group-hover:text-black">
//               Discover all input forms in your app and run quick XSS tests.
//             </p>
//           </div>
//         </Link>
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
        ...
        {/* Card 4 - Crawl History */}
        <Link to="/crawl-history" className="group w-full max-w-sm">
          <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 p-6 rounded-xl shadow-xl transform transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold text-white group-hover:text-gray-800">Crawl History</h2>
              <span className="text-white bg-yellow-700 rounded-full px-3 py-1 text-xs font-bold">
                View
              </span>
            </div>
            <p className="text-white mt-3 group-hover:text-black">
              Review past crawl runs and XSS test results here.
            </p>
          </div>
        </Link>
