...
// Icon imports
import { FaTachometerAlt, FaClipboardCheck, FaHistory, FaCog, FaBug, FaSearch } from 'react-icons/fa';
...
function App() {
  return (
    <Router>
      <div className="min-h-screen flex">
        {/* Static Sidebar */}
        <aside className="w-1/6 bg-gray-800 text-white p-6 h-screen fixed top-0 left-0 shadow-lg">
          <h1 className="text-2xl font-bold mb-8 text-yellow-400">Security Dashboard</h1>
          <nav>
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                <Link to="/crawl" className="hover:text-yellow-300 flex items-center">
                  <FaBug className="mr-2" />
                  <span>Web Crawler</span>
                </Link>
              </li>
              <li className="flex items-center">
                <Link to="/crawl-history" className="hover:text-yellow-300 flex items-center">
        ...
        {/* Main content */}
        <main className="ml-[16.66%] w-[83.33%] bg-gray-100 p-6 min-h-screen">
          <Routes>
            <Route path="/" element={<DashboardHome />} />
            <Route path="/scan" element={<Scanner />} />
            <Route path="/history" element={<ScanHistory />} />
